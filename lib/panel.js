...
let frameScript = "chrome://jsdeobfuscator/content/content.js?" + Math.random();
...
Panel.prototype = {
  ...
  onNavigate: function()
  {
    ...
    this._messageManager.sendAsyncMessage("jsdeobfuscator@palant.de:clear");
